...
public class CadastroController implements CadastroRepository {
    ...
    public void atualizar(Cadastro cadastro) {
        ...
        if (buscaProd != null) {
            ...
            System.out.println("\nO produto de código " + cadastro.getCodigo() + " foi atualizado com sucesso");
    ...
    public void registrarLog(String acao) {
        try (FileWriter escreva = new FileWriter("log.txt", true)) { // true para anexar ao arquivo
